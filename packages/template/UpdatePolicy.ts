import { AutoScalingRollingUpdatePolicy } from './AutoScalingRollingUpdatePolicy';
import { AutoScalingScheduledActionPolicy } from './AutoScalingScheduledActionPolicy';
import { AutoScalingUpdateReplacePolicy } from './AutoScalingUpdateReplacePolicy';
...
export interface UpdatePolicy {
   ...
   * group.
   *
   * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-replacingupdate
   */
  AutoScalingUpdateReplace?: AutoScalingUpdateReplacePolicy;
   ...
   *
   * @see https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-attribute-updatepolicy.html#cfn-attributes-updatepolicy-useonlineresharding
   */
